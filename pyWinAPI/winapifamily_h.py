...
# specific to Server applications
...
# * WINAPI_PARTITION_DESKTOP             usable for Desktop Win32 apps (but
# not store apps)
# * WINAPI_PARTITION_APP                 usable for Windows Universal store
# apps
...
WINAPI_FAMILY_PC_APP = 0x00000002
# Windows Drivers and Tools
WINAPI_FAMILY_PHONE_APP = 0x00000003
# Windows Server Applications
WINAPI_FAMILY_SYSTEM = 0x00000004
...
WINAPI_PARTITION_APP = (
    WINAPI_FAMILY == WINAPI_FAMILY_DESKTOP_APP or
    WINAPI_FAMILY == WINAPI_FAMILY_PC_APP or
...
WINAPI_PARTITION_SYSTEM = (
    WINAPI_FAMILY == WINAPI_FAMILY_SYSTEM or
...
# *
# *     #if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP) and
# !WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP)
# *
# * or
# *
...
# WINAPIFAMILY_PARTITION(WINAPI_PARTITION_APP) and
# !WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP)
# !_INC_WINAPIFAMILY
